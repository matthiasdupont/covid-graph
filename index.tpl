<html>
 ...
 <body>
   <div id="intro-text">
     <p class="normal_text">
      Source Data are coming from the Center for Systems Science and Engineering (CSSE) at Johns Hopkins University <a href="https://github.com/CSSEGISandData/COVID-19">Github Repository</a>
     </p>
